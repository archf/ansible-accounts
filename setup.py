...
setup(
    ...
    description='Ansible accounts role filter_plugins',
    # long_description=get_long_description(LONG_DESCRIPTION_FILE),

    # The project's main homepage.
    # url='https://github.com/archf/filter_plugins',
...
#     entry_points={
#         'console_scripts': [
#             'filter_plugins=filter_plugins.__main__:main',
#         ],
#     },
